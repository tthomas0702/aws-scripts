...
# Need to make only use ext and int subnet, and not mgmt
# t2.nano cannot use 3 interfaces


# This is a script to create mu server in AWS.
...
name="mu"
region="us-west-2"
imageid="ami-7f43f307"  # Amazon Linux 2 LTS Candidate AMI 2017.12.0 (HVM)  
inst_type="t2.nano"
userdata="./userdata/mu-user-data.txt"
